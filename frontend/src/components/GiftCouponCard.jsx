    ...
    transition={{ duration: 0.5, delay: 0.2 }} >
			<div className='space-y-4'>
				<div>
					...
					<input type='text' id='voucher' placeholder='Enter code here' value={userInputCode} onChange={(e) => setUserInputCode(e.target.value)}
          required className='block w-full rounded-lg border border-gray-600 bg-gray-700 p-2.5
        ...
        !isCouponApplied && !coupon && (
          <div className='mt-4'>
            ...
            <motion.button className='mt-2 flex w-full items-center justify-center rounded-lg bg-red-600 px-5 py-2.5
