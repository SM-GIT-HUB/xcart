...
function SignupPage() {
  ...
  return (
    <div className="flex flex-col justify-center py-12 sm:py-1 sm:px-6 lg:px-8">
      <motion.div className='sm:mx-auto sm:w-full sm:max-w-md'
      initial={{ opacity: 0, y: -20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.8 }} >
        <h2 className="mt-2 mb-2 text-center text-3xl font-extrabold text-emerald-400">Create your account</h2>
      </motion.div>
